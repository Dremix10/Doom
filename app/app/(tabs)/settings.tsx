  ...
  return (
    ...
    >
      ...
      <View style={s.card}>
        ...
        <Text style={s.body}>
          No profile, works on any iPhone. Add two quick Shortcuts automations per app
          (opened / closed) that report real usage. Each person does this on their own phone.
        </Text>
